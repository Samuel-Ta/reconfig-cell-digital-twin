...
(Table~\ref{tab:scale}, Fig.~\ref{fig:scale}). Simulated annealing reliably beats random across
...
(Table~\ref{tab:corr}, Fig.~\ref{fig:transfer}). The surrogate correlates with real motion on
...
\begin{figure*}[t]
\centering
\includegraphics[width=0.78\textwidth]{figs/phase3_scale.png}
\caption{Generalization across 50 seeds and two arms. Left: optimized-cost distribution for UR5
and UR10. Right: per-seed improvement of simulated annealing over the equal-budget random baseline
(sorted); SA beats random on $46/50$ (UR5) and $45/50$ (UR10) seeds.}
\label{fig:scale}
\end{figure*}

\begin{figure*}[t]
\centering
\includegraphics[width=0.78\textwidth]{figs/phase3_transfer.png}
\caption{Surrogate vs.\ real RRTstar motion time at scale ($n=16$ per robot, median estimator).
The surrogate correlates with real motion on both arms (UR5 full planning budget, UR10 reduced
budget); fit lines and bootstrap statistics in Table~\ref{tab:corr}.}
\label{fig:transfer}
\end{figure*}
